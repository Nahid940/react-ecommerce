							...
							<div className="col-lg-6 col-12">
								<div className="product-gallery">
									...
									<div className="flex-viewport" style={{overflow: 'hidden', position: 'relative'}}>
										{/* <ul className="slides" style={{width: '1200%', transitionDuration: '0.6s', transform: 'translate3d(-1665px, 0px, 0px)'}}><li data-thumb="images/bx-slider4.jpg" className="clone" style="width: 555px; float: left; display: block;">
												<img src="images/bx-slider4.jpg" alt="#"/>
											</li>
											<li data-thumb="images/bx-slider1.jpg" rel="adjustX:10, adjustY:" className="" style={width: 555px; float: left; display: block}>
												<img src="images/bx-slider1.jpg" alt="#"/>
											</li>
											<li data-thumb="images/bx-slider2.jpg" className="" style="width: 555px; float: left; display: block;">
												<img src="images/bx-slider2.jpg" alt="#"/>
											</li>
											<li data-thumb="images/bx-slider3.jpg" style="width: 555px; float: left; display: block;" className="flex-active-slide">
												<img src="images/bx-slider3.jpg" alt="#"/>
											</li>
											<li data-thumb="images/bx-slider4.jpg" style="width: 555px; float: left; display: block;" className="">
												<img src="images/bx-slider4.jpg" alt="#"/>
											</li>
										<li data-thumb="images/bx-slider1.jpg" rel="adjustX:10, adjustY:" className="clone" style="width: 555px; float: left; display: block;">
												<img src="images/bx-slider1.jpg" alt="#"/>
											</li></ul> */}
											</div>
												<ol className="flex-control-nav flex-control-thumbs">
													<li>
														<img src="images/bx-slider1.jpg" className=""/>
													</li>
													<li>
														<img src="images/bx-slider2.jpg" className=""/>
													</li>
													<li>
														<img src="images/bx-slider3.jpg" className="flex-active"/>
													</li>
													<li>
